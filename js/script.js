var KAL = (function() {
    ...
    kal.init = function() {
        ...
        kal.canvas.width = 1920;
        kal.canvas.height = 1080;
    ...
    kal.onMouseMove = function(e) {
        //kal.screenX = e.screenX; //offset.x;
        //kal.screenY = e.screenY; //offset.x;

        //offset.x += img.width * (e.movementX / kal.w);
	    //offset.y += img.height * (e.movementY / kal.h);
    }
